 ...
 * @generated
 */
public class HostingReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HostingReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Hosting) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeuiBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHosting_4001(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		InteractionObject container = (InteractionObject) getLink()
				.eContainer();
		return DeuiBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHosting_4001(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Hosting getLink() {
		return (Hosting) getElementToEdit();
	}
