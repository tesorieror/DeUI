 ...
 * @generated
 */
public class PlatformItemSemanticEditPolicy extends
		DeuiBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PlatformItemSemanticEditPolicy() {
		super(DeuiElementTypes.Platform_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DeuiVisualIDRegistry.getVisualID(outgoingLink) == ImplementationEditPart.VISUAL_ID) {
