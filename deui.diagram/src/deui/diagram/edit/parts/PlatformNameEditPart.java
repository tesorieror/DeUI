 ...
 * @generated
 */
public class PlatformNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PlatformNameEditPart(View view) {
		super(view);
	}
			...
			parser = DeuiParserProvider
					.getParser(
							...
							DeuiVisualIDRegistry
									.getType(deui.diagram.edit.parts.PlatformNameEditPart.VISUAL_ID));
		}
		return parser;
	}
