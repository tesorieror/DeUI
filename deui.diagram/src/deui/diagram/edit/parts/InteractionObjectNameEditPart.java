...
import deui.diagram.edit.policies.DeuiTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InteractionObjectNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InteractionObjectNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DeuiTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeuiParserProvider
					.getParser(
							DeuiElementTypes.InteractionObject_2002,
							getParserElement(),
							DeuiVisualIDRegistry
									.getType(deui.diagram.edit.parts.InteractionObjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					DeuiEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
