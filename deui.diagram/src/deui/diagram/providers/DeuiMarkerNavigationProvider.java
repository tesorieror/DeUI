...
import deui.diagram.part.DeuiDiagramEditorUtil;

/**
 * @generated
 */
public class DeuiMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = DeuiDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DeuiDiagramEditorUtil.selectElementsInDiagram(editor,
