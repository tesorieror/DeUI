 ...
 * @generated
 */
public abstract class DeuiAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = DeuiDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected DeuiAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
